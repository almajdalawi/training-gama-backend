...
let car: Product = new Product('Car', 12000)
let car2: Product = new Product('Car2', 10000)
let phone: Product = new Product('Phone', 500)
let mohammad: User = new User('Mohammad')
let emad: User = new User('Emad')
...
describe('Bank', () => {
    ...
    it('Perchases a product', () => {
        ...
        expect(mohammad.bankAccount.purchase(car, 'cashhhhhh')).toEqual('Please enter the correct type of the account ("cash" or "credit")');
